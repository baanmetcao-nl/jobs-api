...
ActiveRecord::Schema[7.0].define(version: 20_230_129_151_454) do
  ...
  create_table 'newsletter_email_addresses', force: :cascade do |t|
    t.bigint 'email_address_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['email_address_id'], name: 'index_newsletter_email_addresses_on_email_address_id'
  end
  ...
  create_table 'user_email_addresses', force: :cascade do |t|
    ...
    t.index %w[email_address_id use], name: 'index_user_email_addresses_on_email_address_id_and_use', unique: true
